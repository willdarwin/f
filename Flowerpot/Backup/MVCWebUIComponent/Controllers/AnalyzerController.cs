...
namespace MVCWebUIComponent.Controllers
{
    ...
    public class AnalyzerController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Analyzer> analyzerList = AnalyzerService.GetAnalyzersByUserId(userId);
            List<AnalyzerModel> modelList = Mapper.Map<List<AnalyzerModel>>(analyzerList);
        ...
        public ActionResult CreateAnalyzer(int id = 0)
        {
            ...
            if (id > 0)
            {
                CreateAnalyzerModel createModel = new CreateAnalyzerModel();
        ...
        public ActionResult CreateAnalyzer(CreateAnalyzerModel createModel)
        {
            ...
            Analyzer analyzer = Mapper.Map<Analyzer>(analyzerModel);
        ...
        {
            bool result = AnalyzerService.DeleteAnalyzerById(id);
            if (!result)
            {
        ...
        {
            AnalyzerDetailModel analyzer = new AnalyzerDetailModel
            {
                AnalyzerId = dataid,
            ...
            string widthPersent = 100 / analyzer.Columns.Count + "%";
